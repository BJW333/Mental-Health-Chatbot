...
data_store = DataStore('/Users/blakeweiss/Desktop/testhellowithnewdata/conversation_history.json')
...
(text for text in all_texts), target_vocab_size=2**13)
  ...
  #clear the history after using it for training
            ...
            file_pathforjsontotxt = '/Users/blakeweiss/Desktop/testhellowithnewdata/data/conversation_datajsontotxt.txt'
            ...
            if confidence < CONFIDENCE_THRESHOLD:
                ...
                print("")
                print("This response is flagged for human review due to low confidence.")
                ...
                if corrected_response:
                    ...
                    flagged_for_retraining = True  # Flag this interaction for prioritized retraining
                else:
            ...
            conversation_data = {
                ...
                'reward': reward,  # Your existing reward mechanism
                'flagged_for_retraining': flagged_for_retraining  # New flag based on confidence check
            }
