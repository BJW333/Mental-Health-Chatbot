...
class DynamicRewardSystem:
    ...
    def check_response_relevance(self, user_input, bot_response):
        messages = [
            ...
            {"role": "user", "content": "Did that response make sense and was it detailed enough also was it relevant. Please answer [yes] or [no] if the response made sense. But if the response wasnt detailed enough answer [was not detailed enough] then provide a brief explaination why?"}
        ]
#"Did that response make sense in regards to a conversation and was it relevant. Please answer Yes or No but if the response wasnt detailed enough respond [was not detailed enough] then provide a brief explaination why?"
        try:
        ...
        if "yes" in answer.lower():
            ...
            if "no" or "was not detailed enough" in answer.lower():
                print(answer)
                return False
    ...
    def evaluate_response(self, user_input, bot_response):
        ...
        if is_response_relevant:
            ...
            if is_response_relevant == False: 
                #print("The statement is not relevent return false")
                if self.reward_score > 0:
                #if self.reward_score >= 0:     
                    self.reward_score - 1 # Negative reward   self.reward_score =- 1
                    print("The statement is not relevent return false")
                    return -1
        return 0
...
#deletes start and end tokens new mothod delte if not working
    ...
    def generate_seq2seqresponse(self, input_sentence, num_candidates=10, temperature=0.3): #was at temp 0.9 #was at 0.6 #num canidates was 5 orgnially now 10
...
if os.path.exists("/Users/blakeweiss/Desktop/hello/data/inputtexts.txt") and os.path.exists("/Users/blakeweiss/Desktop/hello/data/outputtexts.txt"):
...
#extract the conversations and save to files
    with open(conversations_file, 'r', encoding='iso-8859-1') as f, \
         open('/Users/blakeweiss/Desktop/hello/data/inputtexts.txt', 'w', encoding='utf-8') as conv_file, \
         open('/Users/blakeweiss/Desktop/hello/data/outputtexts.txt', 'w', encoding='utf-8') as ans_file:
        for line in f:
            parts = line.split(' +++$+++ ')
...
with open('/Users/blakeweiss/Desktop/hello/data/inputtexts.txt', 'r', encoding='utf-8') as conv_file:
    input_texts = conv_file.readlines()
    

with open('/Users/blakeweiss/Desktop/hello/data/outputtexts.txt', 'r', encoding='utf-8') as ans_file:
...
(text for text in all_texts), target_vocab_size=2**13)
  ...
  #clear the history after using it for training
            ...
            file_pathforjsontotxt = '/Users/blakeweiss/Desktop/hello/data/conversation_data.txt'
            ...
            response, confidence = chatbot.generate_seq2seqresponse(user_input, temperature=0.3) # temp was 0.5
