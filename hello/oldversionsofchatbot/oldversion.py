...
#deletes start and end tokens new mothod delte if not working
    ...
    def generate_seq2seqresponse(self, input_sentence, num_candidates=5, temperature=0.9):
        ...
        reranked = self.rerank_candidates(input_sentence, candidates)

        return self.postprocess_sentence(reranked)
    ...
    #lower loss is better
        ...
        return candidates[best_candidate_idx]  #return the best candidate sentence, not its index
    ...
    def load_model(self):
        if os.path.exists('/Users/blakeweiss/Desktop/hello/model_weights.h5'):
            ...
            self.vocab_size = len(self.tokenizer.subwords) + 1

            #recreate the model with the updated vocabulary size
            self.model = Seq2SeqModel(self.vocab_size, self.embedding_dim, self.hidden_units)
            ...
            #if issue use the save weights line
            #self.model.tf.keras.models.load_model('/Users/blakeweiss/Desktop/hello/model_weights.h5')
...
(text for text in all_texts), target_vocab_size=2**13)
    ...
    while True:
        ...
        #new
            ...
            response = chatbot.generate_seq2seqresponse(user_input, temperature=0.6)
